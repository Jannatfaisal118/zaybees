...
const Orders = () => {
  ...
  return (
    <div className="pt-16 px-4 md:px-8 bg-bgLight dark:bg-bgDark text-textLight dark:text-textDark">
      <Title text1={t("my")} text2={t("orders")} />

      {!orders.length ? (
        <div className="mt-8 text-center">
          <p className="text-lg text-subtext dark:text-accent">
            {t("noOrdersYet")}
          </p>
          <button
          ...
          {orders.map((order) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <p>
                  <strong>{t("date")}:</strong> {new Date(order.date).toLocaleString()}
                </p>
                <p>
  <strong>{t("total")}:</strong> {order.currency} {order.amount}
</p>
